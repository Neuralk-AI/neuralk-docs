...
On top of powerful prediction models, the Neuralk API provides expert AI modules, end-to-end  workflows that are infused with business logic and are ready to solve complex industry use cases out of the box.
...
The Neuralk expert modules automate the entire workflow of a predictive use case end-to-end, including:
...
### Commerce: Product Categorization module
